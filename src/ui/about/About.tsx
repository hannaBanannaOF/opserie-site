...
export function About() {
  return (
    <div className="about-wrap flex-col">
      ...
      <p>Com 5 temporadas já lançadas, além de um livro de regras e um jogo que arrecadou mais de 4 milhões de reais Ordem Paranormal detém a marca de mais de 1 milhão de visualizações em seus episódios no YouTube e mais de 100 Mil telespectadores simultâneos durante a Live.</p>
      <h5 className="subtitle centered">A história</h5>
      <p>Após um incêndio na Escola Nostradamus, um bombeiro acabou sendo morto de formas misteriosas. E cabe a Ordo Realitas, ou Ordem da Realidade, investigar e garantir que não exista nada de <i>inabitual</i> nesse caso, ou melhor, paranormal.</p>
      <p>A Ordem então convoca para essa missão três agentes novatos, Elizabeth Webber, Thiago Fritz e Daniel Hartmann para solucionar esse mistério. Os três, juntos com um ex professor Alexander Kothe, investigam o que tem de errado nessa escola e que mistérios ela esconde.</p>
    </div>
  );
}